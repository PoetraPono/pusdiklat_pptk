...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Edit Data Hak Akses</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Edit Data Hak Akses</h6>
	...
	<div class="panel-body">
		<form class="form-horizontal need_validation" action="" role="form" method="post" enctype="multipart/form-data">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control wajib" id="ACCESS_NAME" name="ACCESS_NAME" value="<?php echo $getDetail["ACCESS_NAME"];?>">
					<input type="hidden" class="form-control wajib" id="ACCESS_ID" name="ACCESS_ID" value="<?php echo $getDetail["ACCESS_ID"];?>">
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-12">
						...
						<tbody>
							<?php foreach ($datamenus as $key => $menu) {
								...
								<tr>
									...
									<td align="center">
										<input type="checkbox" name="read[]" class="child<?php echo $menu['MENU_PARENT_ID']; ?> read<?php echo $menu['MENU_PARENT_ID']; ?> ck<?php echo $menu['MENU_ID']; ?> cekbox" data-type="read" id="read_<?php echo $menu['MENU_ID']; ?>" data-parent="<?php echo $menu['MENU_PARENT_ID']; ?>" value="<?php echo $menu['MENU_ID']; ?>" <?php echo $cekedread;?>>
									</td>
									<td align="center">
										<input type="checkbox" name="create[]" class="child<?php echo $menu['MENU_PARENT_ID']; ?> create<?php echo $menu['MENU_PARENT_ID']; ?> ck<?php echo $menu['MENU_ID']; ?> cekbox" data-type="create" id="create_<?php echo $menu['MENU_ID']; ?>" data-parent="<?php echo $menu['MENU_PARENT_ID']; ?>" value="<?php echo $menu['MENU_ID']; ?>" <?php echo $cekedcreate;?>>
									</td>
									<td align="center">
										<input type="checkbox" name="update[]" class="child<?php echo $menu['MENU_PARENT_ID']; ?> update<?php echo $menu['MENU_PARENT_ID']; ?> ck<?php echo $menu['MENU_ID']; ?> cekbox" data-type="update" id="update_<?php echo $menu['MENU_ID']; ?>" data-parent="<?php echo $menu['MENU_PARENT_ID']; ?>" value="<?php echo $menu['MENU_ID']; ?>" <?php echo $cekedupdate;?>>
									</td>
									<td align="center">
										<input type="checkbox" name="delete[]" class="child<?php echo $menu['MENU_PARENT_ID']; ?> delete<?php echo $menu['MENU_PARENT_ID']; ?> ck<?php echo $menu['MENU_ID']; ?> cekbox" data-type="delete" id="delete_<?php echo $menu['MENU_ID']; ?>" data-parent="<?php echo $menu['MENU_PARENT_ID']; ?>" value="<?php echo $menu['MENU_ID']; ?>" <?php echo $cekeddelete;?>>
									</td>
									<td align="center">
										<input type="checkbox" name="approve[]" class="child<?php echo $menu['MENU_PARENT_ID']; ?> approve<?php echo $menu['MENU_PARENT_ID']; ?> ck<?php echo $menu['MENU_ID']; ?> cekbox" data-type="approve" id="approve_<?php echo $menu['MENU_ID']; ?>" data-parent="<?php echo $menu['MENU_PARENT_ID']; ?>" value="<?php echo $menu['MENU_ID']; ?>" <?php echo $cekedapprove;?>>
									</td>
									<td align="center">
										<input type="checkbox" name="print[]" class="child<?php echo $menu['MENU_PARENT_ID']; ?> print<?php echo $menu['MENU_PARENT_ID']; ?> ck<?php echo $menu['MENU_ID']; ?> cekbox" data-type="print" id="print_<?php echo $menu['MENU_ID']; ?>" data-parent="<?php echo $menu['MENU_PARENT_ID']; ?>" value="<?php echo $menu['MENU_ID']; ?>" <?php echo $cekedprint;?>>
									</td>
								</tr>
								<?php } ?>
							</tbody>
