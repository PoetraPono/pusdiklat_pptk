...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('portal/layanan') ?>">Ubah Layanan</a></li>
	...
	<div class="panel-body">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="wajib form-control" id="SERVICE_NAME" name="SERVICE_NAME" placeholder="Nama Pejabat" value="<?php echo $layanan['SERVICE_NAME']?>">
				</div>
			</div>
			<div class="form-group">
				<label for="config_code" class="col-sm-3 control-label mandatory" style="text-align: right">
				...
				<div class="col-sm-4">
					<input type="text" class="wajib form-control" id="SERVICE_LINK" name="SERVICE_LINK" placeholder="Nama Pejabat" value="<?php echo $layanan['SERVICE_LINK']?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<textarea class="wajib form-control" cols="5" placeholder="Jabatan"  name="SERVICE_DESC"  ><?php echo $layanan['SERVICE_DESC']?></textarea>
				</div>
			</div>
