...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Tambah Data Running Text</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Running Text</h6>
	...
	<div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea rows="5" type="text" class="form-control wajib wajib" placeholder="Teks" id="RUN_TEXT" name="RUN_TEXT"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-2">
