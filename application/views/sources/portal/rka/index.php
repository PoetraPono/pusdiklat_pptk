...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">Informasi RKA</li>
    </ul>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-copy"></i>Informasi RKA</h6>
        <a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>portal/rka/create'>Tambah Informasi RKA</a>
    </div>
            ...
            <div class="col-sm-12">
                <div class="tabbable">
                    <ul id="myTab" class="nav nav-tabs tab-bricky">
                        <li class="active">
                            <a href="#aktif" data-toggle="tab" data-id="1">Informasi RKA Aktif</a>
                        </li>
                        <li class="">
                            <a href="#nonaktif" data-toggle="tab" data-id="2">Informasi RKA Nonaktif</a>
                        </li>
                    </ul>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dataaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"portal/rka/listdata/1",
            "aaSorting": [[0, "desc"]],
            "aoColumns": [
        ...
        $('#datanonaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"portal/rka/listdata/0",
            "aaSorting": [[0, "desc"]],
            "aoColumns": [
            { "bSortable": false, "sClass": "text-center" },
            { "sClass": "text-left" },
