...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('portal/slider') ?>">Slider</a></li>
        <li class="active">Master Slider</li>
    </ul>
...
<div class="panel panel-default mki-panel">
	<div class="panel-heading mki-panel-heading">
        <h6 class="panel-title"><i class="icon-quill2"></i>Update Slider</h6>
	</div>
	<div class="panel-body">
		<div class="row">
		<div class="col-md-12">
			<div class="form-group ">
				<label class="col-sm-2 control-label text-right">Phot/Image:</label>

				<div class="col-md-6">
					<img width="120px" src="<?php echo base_url().$popup['POPUP_IMAGE_PATH']; ?>" ></img><br/>
					<input type="file" class="styled form-control" id="gambar_path" name="gambar_path" placeholder="Gambar" value="<?php echo $popup['POPUP_IMAGE_PATH']?>" accept="image/*">
			...
			<div class="form-group ">
				...
				<div class="col-sm-6">
					<textarea rows="5" cols="5" class="form-control" name="POPUP_DESC" placeholder="Deskripsi"><?php echo $popup['POPUP_DESC']?></textarea>
				</div>
			</div>
 ...
 -->
		...
		<div class="form-actions text-left">
			...
			<div class="col-sm-9">
				...
				<a class="btn btn-default mki-btn-danger" href="<?php echo base_url('portal/slider');?>"><i class="icon-exit2"></i> Batal</a>
			</div>
			</div>
			</div>
		</div>
