...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('portal/slider') ?>">Portal</a></li>
...
<div class="panel panel-default mki-panel">
	<div class="panel-heading mki-panel-heading">
        <h6 class="panel-title"><i class="icon-quill2"></i>Master Slider</h6>
	</div>
	<div class="panel-body">
		...
		<div class="col-md-12">
			<div class="form-group ">
				...
				<div class="col-md-6">
					<input type="file" class="styled form-control required" id="gambar_path" name="gambar_path" accept="image/*" placeholder="Gambar">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label text-right">Slider Show/Hide: </label>
				<div class="col-sm-6" >
