...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-copy"></i>Slider </h6>
        <a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>portal/slider/create'>Tambah Data</a> 
    </div>
            ...
            <div class="col-sm-12">
                <div class="tabbable">
                    <ul id="myTab" class="nav nav-tabs tab-bricky">
                        <li class="active">
                            <a href="#aktif" data-toggle="tab" data-id="1">Data Slider Website</a>
                        </li>
                        <!-- <li class="">
                            <a href="#nonaktif" data-toggle="tab" data-id="2">Popup Nonaktif</a>
                        </li> -->
                    </ul>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataaktif">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 100px">Show? </th>
                                            <th class="text-center" style="min-width:90px;width:150px">Aksi</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datanonaktif">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 100px" >Gambar</th>
                                            <th class="text-center" >Deskripsi </th>
                                            <th class="text-center" style="width: 100px">Status Show </th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dataaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"portal/slider/listdataaktif",
            "aaSorting": [[0, "desc"]],
            "aoColumns": [
        ...
        $('#datanonaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"portal/slider/listdatanonaktif",
            "aaSorting": [[0, "desc"]],
            "aoColumns": [
            { "bSortable": false, "sClass": "text-center" },
            { "sClass": "text-left" },
