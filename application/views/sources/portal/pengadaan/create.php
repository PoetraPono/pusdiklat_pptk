...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Tambah Data Pengadaan Barang dan Jasa</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Pengadaan Barang dan Jasa</h6>
	...
	<div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea rows="2" type="text" class="form-control wajib" placeholder="Judul Pengadaan" id="ANNOUN_TITLE" name="ANNOUN_TITLE"></textarea>
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-sm-6">
                	<div class="row">
                		<div class="col-md-5">
			                <input class="form-control from-date wajib" type="text" placeholder="Tanggal Mulai" name="ANNOUN_DATE_START" id="ANNOUN_DATE_START" min="2000-01-01" value="">
                		</div>
                		<div class="col-md-1 text-center control-label">s/d</div>
                		<div class="col-md-5">
		                    <input class="form-control datepicker from-date wajib" type="text" placeholder="Tanggal Selesai" name="ANNOUN_DATE_END" id="ANNOUN_DATE_END" min="2000-01-01" value="">
                		</div>
                	</div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea rows="20" type="text" class="form-control wajib ckeditor wajib" placeholder="Deskripsi" id="ANNOUN_DESCRIPTION" name="ANNOUN_DESCRIPTION"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label text-right">
                ...
                <div class="col-sm-10">
                    <input type="file" class="styled wajib" id="ANNOUN_IMG_PATH" name="ANNOUN_IMG_PATH" accept="image/x-png,image/gif,image/jpeg">
                    <span class="help-block">jenis file yang diijinkan png, jpg & jpeg</span>
					<!-- <input type="hidden" name="filess" id="filess" value="'+ file_name +'"> -->
                </div>
            </div>
