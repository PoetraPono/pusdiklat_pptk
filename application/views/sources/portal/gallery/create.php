		...
		<div class="panel-body">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control wajib" id="GALLERIES_TITLE" name="GALLERIES_TITLE" placeholder="Gallery Name">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="datepicker form-control wajib" id="GALLERIES_DATE" name="GALLERIES_DATE" placeholder="Gallery Date" min="2000-01-01">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea type="text" class="form-control wajib" id="GALLERIES_DESC" name="GALLERIES_DESC" placeholder="Deskripsi Gallery"></textarea> 
					</div>
				</div>
		<!-- 		<div class="form-group">
					<label class="col-sm-2 control-label text-right">Gallery Is In Front<span class="mandatory">*</span>: </label>
					<div class="col-sm-10">
						<label class="radio-inline radio-primary">
							<input type="radio" name="radioIsInFront" class="styled" checked="checked" value="1">
							Yes
						</label>
						<label class="radio-inline radio-primary">
							<input type="radio" name="radioIsInFront" class="styled" value="0">
							No
						</label>
					</div>
				</div> -->
				<div class="form-group">
					...
					<div class="col-sm-8">
						<!-- <input type='file' class="styled" name="gbr-image" id="gbr-image"  multiple="multiple"> -->
						<table class="table table-bordered">
							...
							<tbody id="list_image">
								<tr class="list_image">
									...
									<td><select class="form-control" id="image_type_1" name="image_type[]"><option value="1">Photo Biasa</option><option value="1">Photo 360&deg;</option></select></td>
									<td></td>
								</tr>
							</tbody>
							<tfoot>
...
<!--				</div>-->
				<div class="form-group">
                    ...
                    <input type="hidden" name="<?php echo $csrf['name']; ?>" value="<?php echo $csrf['hash']; ?>">
						...
						<a href="<?php echo base_url();?>portal/gallery" class="btn btn-danger">Kembali</a>
					</div>
				</div>
			</div>
		</div>
