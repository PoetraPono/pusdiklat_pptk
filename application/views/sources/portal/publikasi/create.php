    ...
    <div class="panel-body">
        <form id="mki_form" class="form-horizontal validate" method="post" enctype="multipart/form-data" novalidate="novalidate">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control required" placeholder="Judul Publikasi" name="PUBLIKASI_TITLE" id="PUBLIKASI_TITLE">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="ckeditor" rows="12" id="PUBLIKASI_CONTENT" name="PUBLIKASI_CONTENT"></textarea>
                </div>
            </div>
            ...
            <div class="form-actions text-left">
                ...
                <a href="<?php echo base_url("portal/publikasi") ?>" type="submit" value="Simpan" class="btn btn-primary">Kembali</a>
            </div>
        </form>
    </div>
</div>
