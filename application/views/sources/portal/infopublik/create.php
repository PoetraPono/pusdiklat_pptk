...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Tambah Data Informasi Public</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Informasi Public</h6>
	...
	<div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea rows="2" type="text" class="form-control wajib" placeholder="Judul Pengadaan" id="PUBLIC_TITLE" name="PUBLIC_TITLE"></textarea>
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-sm-6">
                	<div class="row">
                		<div class="col-md-5">
		                    <input class="form-control datepicker from-date wajib" type="text" placeholder="Tanggal" name="PUBLIC_DATE" id="PUBLIC_DATE" min="2000-01-01" value="">
                		</div>
                	</div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea rows="20" type="text" class="form-control wajib ckeditor wajib" placeholder="Deskripsi" id="PUBLIC_DESCRIPTION" name="PUBLIC_DESCRIPTION"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label text-right">
                ...
                <div class="col-sm-10">
                    <input type="file" class="styled wajib" id="PUBLIC_FILE_PATH" name="PUBLIC_FILE_PATH" accept="application/msword, application/pdf">
