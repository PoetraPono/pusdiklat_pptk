...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Detail Sertifikat</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Detail Sertifikat</h6>
	</div>
		...
		<div class="panel-body">
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label text-right">Nama Peserts : </label>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label text-right">Fila : </label>
					<div class="col-sm-2 control-label text-left"></div>
				</div>
				<div class="form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<a href="<?php echo base_url();?>nocategories/sertifikat/update" class="btn btn-xs btn-success">Edit Data</a>
