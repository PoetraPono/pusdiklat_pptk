...
<div class="panel panel-default" style="margin-bottom: 5px !important">
	...
	<div class="panel-body">
	    <div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control wajib" id="add_judul" name="add_judul" placeholder="Nama Paket Soal" value="<?php echo isset($paketsoal['PACKET_NAME'])!=""?$paketsoal['PACKET_NAME']:""; ?>">
			</div>
	    </div>
	    <div class="form-group">
			            		...
			            		foreach ($detailpaket as $k => $v) {
				            		echo '<tr id="pilihan_'.$v['DETPACK_QUESTION_ID'].'">
										...
										<td class="text-center">
											<button type="button" class="btn btn-default btn-icon btn-xs" data-original-title="Hapus" data-placement="top" onclick="del_soal('.$v['DETPACK_QUESTION_ID'].');"><i class="icon-close"></i></button>
											<button type="button" class="btn btn-default btn-icon btn-xs" data-original-title="Ke atas" data-placement="top" onClick="upup('.$v['DETPACK_QUESTION_ID'].')"><i class="icon-arrow-up8"></i></button>
											<button type="button" class="btn btn-default btn-icon btn-xs" data-original-title="Ke bawah" data-placement="top" onClick="downdown('.$v['DETPACK_QUESTION_ID'].')"><i class="icon-arrow-down8"></i></button>
										</td>
									</tr>';
									$no +=1;
				            	}
