...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Modul</h6>
	...
	<div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control wajib" id="SILABUS_NAME" name="SILABUS_NAME" placeholder="Nama Modul" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea rows="10" type="text" class="form-control wajib" placeholder=" Deskripsi" id="SILABUS_DESCRIPTION" name="SILABUS_DESCRIPTION"></textarea>
                </div>
            </div>
