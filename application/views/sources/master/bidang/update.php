	...
	<div class="panel-body">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="wajib form-control" id="SECTOR_NAME" name="SECTOR_NAME" value="<?php echo $bidang['SECTOR_NAME']?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<textarea class="wajib form-control" cols="5"  name="SECTOR_DESC" ><?php echo $bidang['SECTOR_DESC']?></textarea>
				</div>
			</div>
