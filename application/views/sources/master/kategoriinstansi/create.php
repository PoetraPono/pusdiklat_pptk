...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Tambah Data Kategori Instansi</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Kategori Instansi</h6>
		...
		<form class="form-horizontal need_validation" action="" role="form" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="<?php echo base_url();?>master/kategoriinstansi" class="btn btn-xs btn-primary">Kembali</a>
                </div>
            </div>
		</form>
	</div>
