...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Ubah Data Kategori Instansi</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Ubah Data Kategori Instansi</h6>
		
	</div>
	<div class="panel-body">
		<form class="form-horizontal need_validation" action="" role="form" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label for="add_accname" class="col-sm-2 control-label text-right">Nama Kategori Instansi <span class="mandatory">*</span> : </label>
				<div class="col-sm-4">
					<input type="text" class="form-control wajib" id="update_name" name="update_name" placeholder="Nama Instansi" value="<?php echo $instansi['INSTANSI_CATEGORY_NAME']!=''?$instansi['INSTANSI_CATEGORY_NAME']:''; ?>">
				</div>
			</div>
