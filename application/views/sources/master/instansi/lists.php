...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        <li><a href='<?php echo base_url(); ?>'>SI ADVOKASI</a></li>
        <li class="active">Master /Instansi</li>
    </ul>
...
<div class="panel panel-default mki-panel">
    <div class="panel-heading mki-panel-heading">
        <h6 class="panel-title"><i class="icon-users2"></i>Master/Instansi</h6>
        <?php if($this->access->permission('create')){ ?>
            <a class="pull-right btn btn-xs btn-default mki-btn-info" href='<?php echo base_url();?>master/instansi/create'><i class="icon-file-plus"></i>Input Baru</a>
        <?php } ?>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#tabble1').dataTable( {
            ...
            "processing": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"master/instansi/listdata/1",
        ...
        $('#btnaktif').click(function() {
            ...
            if(rowId>0) {
                $.ajax({
                   url : "<?php echo base_url(); ?>master/instansi/aktif/"+rowId,
                   dataType:"json",
        ...
        $('#btnhapus').click(function() {
            ...
            if(rowId>0) {
                $.ajax({
                   url : "<?php echo base_url(); ?>master/instansi/hapus/"+rowId,
                   dataType:"json",
                   success:function(result){
