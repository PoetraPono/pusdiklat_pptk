...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('master/kamar') ?>">Tambah Master Kamar</a></li>
...
<div class="panel panel-default mki-panel">
	<div class="panel-heading mki-panel-heading">
        <h6 class="panel-title"><i class="icon-quill2"></i>Data Jenis Kamar</h6>
	</div>
	<div class="panel-body">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="wajib form-control" id="add_name" name="add_name" placeholder="Nama Kamar">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="wajib form-control" id="add_number" name="add_number" placeholder="Nama Kamar">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="number" class="wajib form-control" id="add_capacity" name="add_capacity" placeholder="Jumlah Kapasitas Kamar">
				</div>
			</div>
		...
		<div class="form-actions text-left">
			...
			<div class="col-sm-9">
				...
				<a class="btn btn-default mki-btn-danger" href="<?php echo base_url('master/kamar');?>"><i class="icon-exit2"></i> Batal</a>
			</div>
			</div>
			</div>
		</div>
