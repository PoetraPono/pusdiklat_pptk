...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">Detail Data Studi Kasus</li>
    </ul>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-copy"></i>Detail Data Studi Kasus</h6>
    ...
    <div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control wajib" id="STUDI_KASUS_NAME" name="STUDI_KASUS_NAME" placeholder="Nama Modul" value="<?php echo $modul['STUDI_KASUS_NAME'];?>" disabled>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea type="text" class="form-control" rows="5" disabled placeholder=" Deskripsi" id="STUDI_KASUS_DESCRIPTION" name="STUDI_KASUS_DESCRIPTION"><?php echo $modul['STUDI_KASUS_DESCRIPTION']; ?></textarea>
                </div>
            </div>
            ...
            <!-- <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="<?php echo base_url().$modul['STUDI_KASUS_FILE_PATH'];?>" download> download</a></label>
                    <?php }else{ ?>
