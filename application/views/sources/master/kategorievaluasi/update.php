...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('master/pidana') ?>">Kategori Evaluasi</a></li>
...
<div class="panel panel-default mki-panel">
	<div class="panel-heading mki-panel-heading">
        <h6 class="panel-title"><i class="icon-quill2"></i>Ubah Poin Evaluasi</h6>
	</div>
	<div class="panel-body">
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				<label for="config_code" class="col-sm-3 control-label " style="text-align: right">
					Kategori Evaluasi <span class="mandatory">*</span>
				</label>
				<div class="col-sm-9">
					<input type="text" class="wajib form-control" id="" name="EVALUASI_POINT_NAME" placeholder="Nama Poin Evaluasi" value="<?php echo $pidana['EVALUASI_POINT_NAME']?>">
			</div>
		...
		<div class="form-actions text-left">
			...
			<div class="col-sm-9">
				...
				<a class="btn btn-default mki-btn-danger" href="<?php echo base_url('master/kategorievaluasi');?>"><i class="icon-exit2"></i> Batal</a>
			</div>
			</div>
			</div>
		</div>
