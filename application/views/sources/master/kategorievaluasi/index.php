...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">Master Kategori Evaluasi</li>
    </ul>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-copy"></i>Kategori Evaluasi</h6>
        <a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>master/kategorievaluasi/create'>Tambah Data</a>
    </div>
            ...
            <div class="col-sm-12">
                <div class="tabbable">
                    <ul id="myTab" class="nav nav-tabs tab-bricky">
                        <li class="active">
                            <a href="#aktif" data-toggle="tab" data-id="1">Kategori Evaluasi Aktif</a>
                        </li>
                        <li class="">
                            <a href="#nonaktif" data-toggle="tab" data-id="2">Kategori Evaluasi Nonaktif</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="aktif">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataaktif">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="min-width:50px;width:50px">No</th>                                           
                                            <th class="text-center">Kategori Evaluasi</th>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="datanonaktif">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="min-width:50px;width:50px">No</th>                                            
                                            <th class="text-center">Poin Evaluasin</th>
                                            <!-- <th class="text-center">Status</th> -->
                                            <th class="text-center" style="min-width:90px;width:90px">Aksi</th>
                                        </tr>
                                    </thead>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dataaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"master/kategorievaluasi/listdataaktif",
            "aaSorting": [[0, "asc"]],
            "aoColumns": [
        ...
        $('#datanonaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"master/kategorievaluasi/listdatanonaktif",
            "aaSorting": [[0, "asc"]],
            "aoColumns": [
            { "bSortable": false, "sClass": "text-center" },
            { "sClass": "text-left" },
