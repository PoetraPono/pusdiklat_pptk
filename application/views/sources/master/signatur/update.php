...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url('master/bidang') ?>">Ubah Master Signature</a></li>
	...
	<div class="panel-body">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="wajib form-control" id="SIGNATURE_NAME" name="SIGNATURE_NAME" placeholder="Nama Pejabat" value="<?php echo $signatur['SIGNATURE_NAME']?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<textarea class="wajib form-control" cols="5" placeholder="Jabatan"  name="SIGNATURE_JABATAN"  ><?php echo $signatur['SIGNATURE_JABATAN']?></textarea>
				</div>
			</div>
