...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Detail Data Tes Online</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Detail Data Tes Online</h6>
    ...
    <form id="mki_form" method="post" enctype="multipart/form-data" novalidate="novalidate">
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Nama Tes Online : </label>
                    <div class="col-sm-2 control-label text-left"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <a href="<?php echo base_url();?>tes/tes_online/update" class="btn btn-xs btn-success">Edit Data</a>
