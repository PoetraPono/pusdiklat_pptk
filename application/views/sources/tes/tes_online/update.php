...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Edit Data Tes Online</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Edit Data Tes Online</h6>
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control wajib" placeholder="Tes Online">
                    </div>
                </div>
                <div class="form-group">
