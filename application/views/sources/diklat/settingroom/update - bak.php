                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="row block-inner">
                                ...
                                <?php if($v['ROOM_ACTIVE'] == 1){
                                    $ROOM_STATUS = ($v['ROOMS_IS_FULL'] == 1 ? 1 : $v['ROOM_STATUS']);
                                    ?>
                                    <div class="col-md-2" style="margin-bottom: 5px;display: block;height: 150px; padding-left: 2px; padding-right: 2px;" >
                                        <a href="javascript:void(0);" class="rooms" id="room_<?php echo $v['ROOMS_ID']; ?>" style="border-radius: 4px;  border: 1px solid #BADA55; padding-left: 5px; padding-right: 5px; <?php echo ($ROOM_STATUS > 0 ? "background-color:red; color:black;" : "0"); ?> " data-capactity="<?php echo $v['ROOMS_CAPACITY']; ?>" is-active="<?php echo ($ROOM_STATUS > 0 ? "2" : "0"); ?>" room-id="<?php echo $v['ROOMS_ID']; ?>"  <?php echo ($ROOM_STATUS == 0 ?  'onclick="chooseRoom(this)"' : ""); ?> room-no="<?php echo $v['ROOMS_NUMBER']; ?>">
        ...
        $('.space_'+roomid).each(function() {            
            if($(this).attr('isi')==0){
                ...
                if(isoke == 1){
                    ...
                    alert("Maaf Laki-laki dan Perempuan tidak boleh satu kamar");
