...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">Pendjadwalan Kamar</li>
    </ul>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-copy"></i>Daftar Pendjadwalan Kamar</h6>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#dataaktif').dataTable( {
            ...
            "serverSide": true,
            "bServerSide": true,
            "sAjaxSource": baseurl+"diklat/settingroom/listdataaktif",
            "aaSorting": [[0, "desc"]],
            "aoColumns": [
