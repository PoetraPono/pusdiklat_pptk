...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">Program Diklat</li>
    </ul>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-copy"></i>Program Diklat</h6>
        <a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>diklat/program/create'>Tambah Program Diklat</a>
    </div>
            ...
            <div class="col-sm-12">
                <div class="tabbable">
                    <ul id="myTab" class="nav nav-tabs tab-bricky">
                        <li class="active">
                            <a href="#aktif" data-toggle="tab" data-id="1">Program Diklat Aktif</a>
                        </li>
                        <li class="">
                            <a href="#nonaktif" data-toggle="tab" data-id="2">Program Diklat Nonaktif</a>
                        </li>
                    </ul>
