...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Ubah Data Program Diklat</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Ubah Data Program Diklat</h6>
	...
	<div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control wajib" id="PROGRAM_NAME" name="PROGRAM_NAME" placeholder="Nama Diklat" value="<?php echo $diklat['PROGRAM_NAME'];?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control wajib" id="PROGRAM_DESCRIPTION" name="PROGRAM_DESCRIPTION" rows="4"><?php echo $diklat['PROGRAM_DESCRIPTION']; ?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="fg-line">
                            <select id="PROGRAM_TYPE" class="select2 wajib" name="PROGRAM_TYPE" data-placeholder="Pilih Jenis Diklat">
                                    <option value="1" <?php echo ($diklat['PROGRAM_TYPE'] == 1 ? "selected" : ""); ?>>Internal</option>
                                    <option value="2" <?php echo ($diklat['PROGRAM_TYPE'] == 2 ? "selected" : ""); ?>>Eksternal</option>
                                    <option value="2" <?php echo ($diklat['PROGRAM_TYPE'] == 3 ? "selected" : ""); ?>>Internal & Eksternal</option>
            ...
            <div class="form-group">
                <label for="nama_katering" class="col-sm-2 control-label text-right">Bidang<span class="field-required">*</span></label>
                  <div class="col-sm-4">
                    <div class="fg-line">
                        <?php if(count($bidang)>0){ ?>
                            <select id="PROGRAM_SECTOR_ID" class="select2 wajib" name="PROGRAM_SECTOR_ID" data-placeholder="Pilih Nama bidang">
                                <option value="0"> Pilih Bidang Diklat</option>
                                   <?php foreach ($bidang as $bid) { 
                                    $select = ($bid['SECTOR_ID'] == $diklat['PROGRAM_SECTOR_ID']) ? "selected" : "";
                                    ?>
                                       <?php 
                                        echo '<option value="'.$bid['SECTOR_ID'].'" '.$select.'>'.$bid['SECTOR_NAME'].'</option>';
                                       ?>
                                      <?php } ?> 
                                </select>
                                 <?php }else{ ?>
                                 <select class="tag-select" disabled>
                                    <option value="0"> Data Bidang Kosong!</option>
                                </select>
                        <?php } ?>
                    </div><small class="help-block"></small>
                 </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control wajib" id="PROGRAM_SASARAN" name="PROGRAM_SASARAN" rows="4"><?php echo $diklat['PROGRAM_SASARAN']; ?></textarea>
                   <!--  <div class="fg-line">
                        <textarea class="form-control wajib" id="PROGRAM_SASARAN" name="PROGRAM_SASARAN" rows="4"></textarea>
                        <select data-placeholder="SASARAN DIKLAT" class="form-control wajib" tabindex="9" name="PROGRAM_SASARAN_ID" id="new_sasaran" placeholder="Sasaran Diklat" >
                            
                        </select>
                        <input type="hidden" class="form-control wajib" id="up_sasaran_id" placeholder="Tanggal mulai" value="<?php echo $diklat['PROGRAM_SASARAN_ID']; ?>">
                    </div><small class="help-block"></small> -->
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="datepicker form-control wajib" id="PROGRAM_START" name="PROGRAM_START" placeholder="Tanggal mulai" value="<?php echo date('m/d/Y',strtotime($diklat['PROGRAM_START'])); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label text-right">
                ...
                <div class="col-sm-2">
                    <input type="text" class="datepicker form-control wajib" id="PROGRAM_END" name="PROGRAM_END" placeholder="Tanggal selesai" value="<?php echo date('m/d/Y',strtotime($diklat['PROGRAM_END'])); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control wajib" placeholder="jumlah mata ajar" id="PROGRAM_TOTAL_LESSON" name="PROGRAM_TOTAL_LESSON" value="<?php echo $diklat['PROGRAM_TOTAL_LESSON']; ?>">
                </div>
            </div>
             <div class="form-group">
                <label for="" class="col-sm-2 control-label text-right">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control wajib" placeholder="total jam" id="PROGRAM_TOTAL_HOURS" name="PROGRAM_TOTAL_HOURS" value="<?php echo $diklat['PROGRAM_TOTAL_HOURS']; ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label text-right">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control wajib" placeholder="jumlah kuota" id="PROGRAM_TOTAL_KUOTA" name="PROGRAM_TOTAL_KUOTA" value="<?php echo $diklat['PROGRAM_TOTAL_KUOTA']; ?>">
                </div>
            </div>
             <div class="form-group">
                ...
                <?php if($diklat['PROGRAM_ATTACHMENT_PATH'] != ""){ ?>
                <div class="col-sm-2 control-label">     
                      <a href="<?php echo base_url().$diklat['PROGRAM_ATTACHMENT_PATH']; ?>" title="diklat" download="<?php echo $diklat['PROGRAM_ATTACHMENT_PATH']; ?>">download lampiran</a>
                </div>
                <?php } ?>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php if($diklat['PROGRAM_IMAGE_PATH'] != ""){ ?>
                    <div class="block">
                        <div class="thumbnail">
                            <a href="<?php echo base_url().$diklat['PROGRAM_IMAGE_PATH']; ?>" class="thumb-zoom lightbox" title="publikasi Image">
                                <img src="<?php echo base_url().$diklat['PROGRAM_IMAGE_PATH']; ?>" >
                            </a>
                        </div>
                    </div>
                    <?php } ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control wajib" id="PROGRAM_RQUISITE" name="PROGRAM_RQUISITE" rows="4"><?php echo $diklat['PROGRAM_RQUISITE']; ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-2">
...
<script type="text/javascript">
    ...
    function getsasaran(id){
            $.ajax({
                url : "<?php echo base_url('diklat/program/json_sasaran');?>/"+ id,
                type: "GET",
                dataType: "JSON",
                success: function(data){
                    var getlist = '<option value=""><i>-- Pilih salah satu --</i></option>';
                    $.each(data, function(index) {
                        if(data[index].TINDAK_PIDANA_SECTOR_ID =="<?php echo $diklat['PROGRAM_SASARAN_ID']; ?>"){
                            getlist += '<option value="'+ data[index].TINDAK_PIDANA_SECTOR_ID +'" selected>'+ data[index].TINDAK_PIDANA_NAME +'</option>';
                        }else{
                            getlist += '<option value="'+ data[index].TINDAK_PIDANA_SECTOR_ID +'">'+ data[index].TINDAK_PIDANA_NAME +'</option>';
                        }
                    });
 ...
 <script type="text/javascript">
      $(document).ready(function(){
         getsasaran($("#PROGRAM_SECTOR_ID").val());
      })
        // $("#PROGRAM_SECTOR_ID").change(function(){
        //     getsasaran();
        // })
        ...
        function getsasaran(id){
            $.ajax({
                ...
                success: function(data){
                    var getlist = '<option value=""><i>-- Pilih salah satu --</i></option>';
                    $.each(data, function(index) {
                        if(data[index].TINDAK_PIDANA_ID == $("#up_sasaran_id").val()){
                            getlist += '<option value="'+ data[index].TINDAK_PIDANA_ID +'" selected>'+ data[index].TINDAK_PIDANA_NAME +'</option>';
                        }else{
                            getlist += '<option value="'+ data[index].TINDAK_PIDANA_ID +'">'+ data[index].TINDAK_PIDANA_NAME +'</option>';
                        }
                    });
                    $("#new_sasaran").html("").append(getlist);
                    //$("#new_sasaran").select2();
                },
                error: function (jqXHR, textStatus, errorThrown){}
            });
