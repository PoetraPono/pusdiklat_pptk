...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Jadwal</h6>
		
	</div>
	<div class="panel-body">
		<form class="form-horizontal need_validation" action="" role="form" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label for="add_accname" class="col-sm-2 control-label text-right">Nama Jadwal <span class="mandatory">*</span> : </label>
				<div class="col-sm-4">
				...
				<div class="col-sm-12">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<?php $padding = ($menu["menu_level"] == 2)?'padding-left:30px;':(($menu["menu_level"] == 3)?'padding-left:60px;':''); ?>
							<tr>
								<td>
