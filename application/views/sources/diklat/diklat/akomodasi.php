...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Tambah Data Akomodasi</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Tambah Data Akomodasi</h6>
        ...
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nama_katering" class="col-sm-2 control-label text-right">
                    Ruanagn <span class="mandatory">*</span> :
                </label>
                <div class="col-sm-10">
                    <select id="nama_katering" class="select2 wajib" name="nama_katering[]" data-placeholder="Pilih Nama Katering">
                        <option></option>
                        <option value="1">Nama Kamar</option>
                        <option value="2">Nama Kamar</option>
                        <option value="3">Nama Kamar</option>
                        <option value="4">Nama Kamar</option>
                        <option value="5">Nama Kamar</option>
                        <option value="6">Nama Kamar</option>
                        <option value="7">Nama Kamar</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <label for="nama_katering" class="col-sm-2 control-label text-right">
                    Kamar <span class="mandatory">*</span> :
                </label>
                <div class="col-sm-10">
                    <select id="nama_katering" class="select2 wajib" name="nama_katering[]" data-placeholder="Pilih Nama Katering">
                        <option></option>
                        <option value="1">No Kamar</option>
                        <option value="2">No Kamar</option>
                        <option value="3">No Kamar</option>
                        <option value="4">No Kamar</option>
                        <option value="5">No Kamar</option>
                        <option value="6">No Kamar</option>
                        <option value="7">No Kamar</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
