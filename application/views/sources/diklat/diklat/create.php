	...
	<div class="panel-body">
        <form class="form-horizontal need_validation" action="" id="mki_form" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control wajib" placeholder="Nama Diklat">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control wajib" placeholder="Kuota">
                </div>
            </div>
            <div class="form-group">
                <label for="nama_katering" class="col-sm-2 control-label text-right">
                    Katering <span class="mandatory">*</span> :
                </label>
                <div class="col-sm-10">
                    <select id="nama_katering" class="select2 wajib" name="nama_katering[]" data-placeholder="Pilih Nama Katering">
                        <option></option>
                        <option value="1">Nama Katering</option>
                        <option value="2">Nama Katering</option>
                        <option value="3">Nama Katering</option>
                        <option value="4">Nama Katering</option>
                        <option value="5">Nama Katering</option>
                        <option value="6">Nama Katering</option>
                        <option value="7">Nama Katering</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="nama_materi" class="select-multiple wajib" multiple="multiple" name="nama_materi[]" data-placeholder="Pilih Nama Materi">
                        <option></option>
                        <option value="1">Nama Materi</option>
                        <option value="2">Nama Materi</option>
                        <option value="3">Nama Materi</option>
                        <option value="4">Nama Materi</option>
                        <option value="5">Nama Materi</option>
                        <option value="6">Nama Materi</option>
                        <option value="7">Nama Materi</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
