...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">Detail Data Silabus</li>
	</ul>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Detail Data Silabus</h6>
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <a href="<?php echo base_url();?>diklat/Silabus/update<?php /*echo $pengguna["user_id"];*/?>" class="btn btn-xs btn-success">Edit Data</a>
