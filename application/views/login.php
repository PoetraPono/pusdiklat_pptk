...
<body class="full-width page-condensed">
    ...
    <div class="login-wrapper">
        <form class="need_validation" action="<?php echo base_url(); ?>home/auth/checklogin" role="form" method="post" enctype="multipart/form-data">
            <div class="popup-header">
                ...
                <br/>
                <span class="text-semibold">WEBSITE PUSDIKLAT Pusdiklat PPATK</span> -->
                <span class="text-semibold">SINDIKAT - PUSDIKLAT APU PPT</span>
                <br/>
                <span class="text-semibold">PUSAT PENDIDIKAN PELATIHAN ANTI PENCUCIAN UANG DAN PENCEGAHAN PENDANAAN TERORISME</span>
            </div>
            <div class="well">
                <?php if($message!=""){?>
                ...
                <fieldset>
                    ...
                    <div id="captcha" class="form-group has-feedback" style="margin-bottom: 5px !important">
                        <label style="color:white">Captcha23123123</label>
                        <div class="controls">
                            <div style="height:50px;">
                                <img id="captchaimg" style="height:50px;width: 235px" src="<?php echo base_url('home/auth/get_captcha'); ?>">
                                <a href="javascript:void(0);" onclick="document.getElementById('captchaimg').src='<?php echo base_url('home/auth/get_captcha'); ?>?'+Math.random();document.getElementById('loginform').focus();">&nbsp;&nbsp;&nbsp;<i style="color: white" class="icon-loop4"></i></a>
                            </div>
                        </div>
                    </div>

                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="Captcha" name="captcha" id="captchain">
                        <i class="icon-key form-control-feedback" style="top:0px !important"></i>
                    </div>

                    <div class="row form-actions">
                        <div class="col-xs-12">
                            <input type="hidden" name="<?php echo $csrf['name']; ?>" value="<?php echo $csrf['hash']; ?>">
                            <button type="submit" class="btn btn-primary pull-right col-xs-12" style="background-color:#19476E;border-color:#ddd;">SIGN IN</button>
                        </div>
                    </div>
                </fieldset>
            </div>
    ...
    <div class="footer clearfix">
        <div class="pull-center">
            Hak Cipta &copy; 2016 Mediatama Kreasi Informatika. All Right Reserved.134134
        </div>
    </div>
</body>
</html>