...
class Profile extends CI_Controller {
	...
	public function index($web_id = 0){
		$user = $this->profile_model->getDetailprofile($this->session->userdata('user_id'))->row_array();
	...
	public function editprofile($web_id = 0){
		if($post = $this->input->post()){
			...
			$this->profile_model->updateemployee($dataupdateemployee,$getSys['user_employee_id']);
			$dataupdate = array(
